...
def _probe_gemini():
    ...
    try:
        ...
        logfire.info("Gemini embeddings are ready")
        return model 
    except Exception as e:
        logfire.warning(f"Gemini embeddings failed due to {e}")
        return None 
...
def _init():
    """ Initializing embedding model once per process .called lazily on first use"""
